             ...
             setState(() {
               searchval=query;
                     ...
                     children: [
                       ...
                       SizedBox(width: 7,),
                       Text('disable user list',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14,fontFamily: 'Montserrat',color: Colors.blue[900]),),
                     ],
                   ),
                   actions: [
         ...
         children: [
           Container(
             ...
             child: StreamBuilder<QuerySnapshot>(
                    stream: Firestore.instance.collection('users').where('level', isEqualTo:'disable' ).where('visable',isEqualTo: 'yes').snapshots(),
